...
export default function BrandPage({ params }: { params: Promise<{ slug: string }> }) {
 ...
 return (
   <main className="min-h-screen flex flex-col" style={{ background: `linear-gradient(160deg, ${brand.bgColor}dd 0%, ${brand.bgColor} 100%)` }}>
     ...
     <section className="flex-1 flex flex-col justify-center px-16 py-8 max-w-4xl mx-auto w-full gap-10">

       <h1 className="text-white font-light uppercase tracking-widest" style={{ fontSize: "clamp(1rem, 2vw, 1.5rem)" }}>
         {brand.name}
       </h1>
       ...
       <div className="flex flex-col gap-6">
         <div className="flex items-baseline justify-between gap-8">
           <p className="text-white/50 font-light shrink-0" style={{ fontSize: "clamp(0.9rem, 1.5vw, 1.1rem)" }}>
             {brand.unit} since you arrived
           </p>
           <p className="tabular-nums font-thin text-white text-right" style={{ fontSize: "clamp(2rem, 4vw, 3rem)", letterSpacing: "-0.03em", fontFamily: "-apple-system, 'SF Pro Display', BlinkMacSystemFont, sans-serif" }}>
         ...
         <div className="flex items-baseline justify-between gap-8">
           ...
           <p className="tabular-nums font-thin text-white/60 text-right" style={{ fontSize: "clamp(2rem, 4vw, 3rem)", letterSpacing: "-0.03em", fontFamily: "-apple-system, 'SF Pro Display', BlinkMacSystemFont, sans-serif" }}>
